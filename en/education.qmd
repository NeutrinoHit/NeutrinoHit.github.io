...
<div class="lecture-catalog">
  ...
  <section class="lecture-course-list" aria-label="Lecture catalog">
      ...
      <div class="lecture-course-body">
        ...
        <div class="lecture-material-list">
          ...
          <details id="unruh-course" class="lecture-material">
            ...
            <div class="lecture-material-body">
              <p>Five Russian-language HTML lectures, from Rindler coordinates and entanglement entropy to the Unruh effect for scalar and fermion fields.</p>
              <div class="lecture-course-actions">
                <a class="lecture-action-primary" href="../qft-lectures/unruh/">Open mini-course</a>
              </div>
            </div>
          </details>
    ...
    <details id="stat" class="lecture-course lecture-course-stat">
      ...
      <div class="lecture-course-body">
        <p>A practical course for high-energy physics, astrophysics, and experimental data analysis. The Russian course has thirteen lectures; English-language lectures are listed directly below.</p>
        <div class="lecture-course-actions">
...
```{=html}
    ...
    <details id="gravity" class="lecture-course lecture-course-gravity">
      <summary>
        <span class="lecture-course-status">In preparation · first lecture draft</span>
        <span class="lecture-course-title">Gravity</span>
      </summary>
      <div class="lecture-course-body">
        <p>Working site for a future course on gravity and general relativity. The first Russian-language lecture studies light signals exchanged by freely falling objects near a black-hole horizon.</p>
        <div class="lecture-course-actions">
          <a class="lecture-action-primary" href="../gravity/">Open course site</a>
          <a href="../gravity/ru/slides/01_radial_signals.html">01. Light signals near the horizon (Russian)</a>
        </div>
      </div>
    </details>
